...
export default function Dashboard() {
  ...
  const handleExportCSV = () => {
    ...
    const rows = responses.map((r) => [
      ...
      r.sweetsFreq || "",
      (r as Record<string, unknown>).sugaryDrinksFrequency || "",
      (r as Record<string, unknown>).fastFoodFrequency || "",
      (r as Record<string, unknown>).breakfastFrequency || "",
      (r as Record<string, unknown>).lateNightEating || "",
      (r as Record<string, unknown>).dietType || "",
      r.mealsPerDay || "",
      r.waterLitersPerDay || "",
      // Estilo de vida
      ...
      r.smokingStatus || "",
      r.alcoholFrequency || "",
      (r as Record<string, unknown>).screenTimeHours || "",
      (r as Record<string, unknown>).socialMediaHours || "",
      r.sleepQuality || "",
      (r as Record<string, unknown>).sleepHoursPerNight || "",
      (r as Record<string, unknown>).wakeUpTired || "",
      (r as Record<string, unknown>).sleepLatency || "",
      r.bloodPressureMedication || "",
      // Saúde mental
      (r as Record<string, unknown>).stressLevel || "",
      (r as Record<string, unknown>).anxietyFrequency || "",
      (r as Record<string, unknown>).mentalHealthDiagnosis || "",
      // Sintomas
      r.symptomFatigue,
      ...
      (r as Record<string, unknown>).symptomHairLoss ?? "",
      (r as Record<string, unknown>).symptomBrainFog ?? "",
      (r as Record<string, unknown>).symptomConstantHunger ?? "",
      (r as Record<string, unknown>).symptomFrequentUrination ?? "",
      (r as Record<string, unknown>).symptomPalpitations ?? "",
      // Saúde feminina
      (r as Record<string, unknown>).irregularMenstrualCycle || "",
      (r as Record<string, unknown>).pcosDiagnosis || "",
      // Histórico familiar
      r.familyDiabetes || "",
